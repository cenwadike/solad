...
var ICONS = {
  add: async () => (await import("./add-73WHBZLA.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-ZKCMIGSV.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-ECNN7PD2.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-FZW4MDFW.js")).appStoreSvg,
  apple: async () => (await import("./apple-ZVOONZZZ.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-HKZR7SFM.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-UP3K4QOF.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-NJIRJB6C.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-YSKWSMW3.js")).arrowTopSvg,
  bank: async () => (await import("./bank-W7TX5LK6.js")).bankSvg,
  browser: async () => (await import("./browser-KPCLEDUL.js")).browserSvg,
  card: async () => (await import("./card-6L5PUU3L.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-KEWTKCRE.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-KIA7XH5E.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-24ASZAKL.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-3SCX4IWR.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-7G7FQEMY.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-DCRYS2JI.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-4WGM24WL.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-5VAD4ZNP.js")).clockSvg,
  close: async () => (await import("./close-OGJ25VI2.js")).closeSvg,
  compass: async () => (await import("./compass-A2UXVURY.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-EOUDMGJP.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-6M7HMCTY.js")).copySvg,
  cursor: async () => (await import("./cursor-2253Q4NR.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-YJNUQ42M.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-5IOPXDTJ.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-IWVM3ANN.js")).disconnectSvg,
  discord: async () => (await import("./discord-2YALN6ES.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-CU27QXSE.js")).etherscanSvg,
  extension: async () => (await import("./extension-NL3ANIB7.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-KUXQJVMN.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-CK3LMTR2.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-NOQXFPKT.js")).farcasterSvg,
  filters: async () => (await import("./filters-OTO7XPTP.js")).filtersSvg,
  github: async () => (await import("./github-4OXVSY33.js")).githubSvg,
  google: async () => (await import("./google-Z7XYIO4S.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-AI55L6MD.js")).helpCircleSvg,
  image: async () => (await import("./image-LQC7POYK.js")).imageSvg,
  id: async () => (await import("./id-KRHFCIAT.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-5U2A2AGB.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-ATDXFMXL.js")).lightbulbSvg,
  mail: async () => (await import("./mail-4UHRYKJD.js")).mailSvg,
  mobile: async () => (await import("./mobile-T6A4B2VO.js")).mobileSvg,
  more: async () => (await import("./more-YH4OQFND.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-SJWALMYM.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-DQNVHHFR.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-I4GJPB3O.js")).offSvg,
  playStore: async () => (await import("./play-store-4MBJFHMC.js")).playStoreSvg,
  plus: async () => (await import("./plus-C7GPHIKE.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-JEGM2SQS.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-PKA5IIQP.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-DBZQJN2G.js")).refreshSvg,
  search: async () => (await import("./search-POZE62VZ.js")).searchSvg,
  send: async () => (await import("./send-CXGM6EQL.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-RIPBFGAA.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-ZXIT7ZHE.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-Y7FWYCHM.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-DH7NC7XN.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-UF2DEMPY.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-I7V43A5Z.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-OASH2PV4.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-HTM6KXK2.js")).twitchSvg,
  twitter: async () => (await import("./x-4WY4P5NB.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-TYQZBUNI.js")).twitterIconSvg,
  verify: async () => (await import("./verify-NOKLFQJ6.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-73DNQDFJ.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-ZAO2OXBI.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-P24XNV2Z.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-P24XNV2Z.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-P24XNV2Z.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-WOS64BBU.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-67XC3XXB.js")).warningCircleSvg,
  x: async () => (await import("./x-4WY4P5NB.js")).xSvg,
  info: async () => (await import("./info-YUMDU3YQ.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-J45NK3CB.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-LDWDLNOF.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UOKMUCF7.js.map
